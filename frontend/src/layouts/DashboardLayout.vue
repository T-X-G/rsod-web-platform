      ...
      >
        ...
        <div class="p-3 border-t border-primary/10">
          <div class="flex items-center gap-3 mb-3">
            <div
              class="w-10 h-10 min-w-[40px] rounded-full ring-2 ring-primary/30 overflow-hidden"
            >
              <img
          ...
          <transition name="fade-slide">
            <div v-if="sidebarExpanded" class="flex items-center gap-2">
              <button
                class="flex-1 flex items-center justify-center gap-2 text-gray-400 hover:text-primary hover:bg-primary/10 transition-all py-2 rounded-lg text-sm"
              >
                <svg
                  class="w-4 h-4"
                  fill="none"
              ...
              <button
                @click="handleLogout"
                class="flex-1 flex items-center justify-center gap-2 text-gray-400 hover:text-accent hover:bg-accent/10 transition-all py-2 rounded-lg text-sm"
              >
                <svg
                  class="w-4 h-4"
                  fill="none"
