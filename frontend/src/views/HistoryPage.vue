...
const historyRecords = ref([
  {
    id: 1,
    filename: "steel_sheet_20241201.jpg",
    image: "https://neeko-copilot.bytedance.net/api/text_to_image?prompt=steel%20surface%20with%20cracks&image_size=landscape_4_3",
    type: "single",
    status: "completed",
    time: "2024-12-01 14:30",
    count: 1,
    targets: 3,
    detectedTargets: ["裂纹", "斑点", "划痕"],
  },
  {
    id: 2,
    filename: "steel_batch.zip",
    image: "https://neeko-copilot.bytedance.net/api/text_to_image?prompt=metal%20surface%20defects&image_size=landscape_4_3",
    type: "batch",
    status: "completed",
    time: "2024-12-01 10:15",
    count: 15,
    targets: 28,
    detectedTargets: ["麻面", "轧入氧化皮", "夹杂物"],
  },
  {
    id: 3,
    filename: "production_line",
    image: "https://neeko-copilot.bytedance.net/api/text_to_image?prompt=industrial%20steel%20production&image_size=landscape_4_3",
    type: "folder",
    status: "processing",
  ...
  },
  {
    ...
    image: "https://neeko-copilot.bytedance.net/api/text_to_image?prompt=quality%20inspection%20of%20metal&image_size=landscape_4_3",
    type: "video",
    status: "completed",
    time: "2024-11-30 09:20",
    count: 1,
    targets: 156,
    detectedTargets: ["裂纹", "麻面", "划痕"],
  },
  {
    id: 5,
    filename: "test_sample.jpg",
    image: "https://neeko-copilot.bytedance.net/api/text_to_image?prompt=metal%20quality%20test&image_size=landscape_4_3",
    type: "single",
    status: "failed",
  ...
  {
    id: 6,
    filename: "steel_coil.jpg",
    image: "https://neeko-copilot.bytedance.net/api/text_to_image?prompt=steel%20coil%20in%20factory&image_size=landscape_4_3",
    type: "single",
    status: "completed",
    time: "2024-11-28 15:30",
    count: 1,
    targets: 5,
    detectedTargets: ["轧入氧化皮", "夹杂物", "斑点"],
  },
]);
